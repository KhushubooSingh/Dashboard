...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | IIT Kanpur</title>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                                <div class="p
                                -2 border-top-0 border-start-0 border-end-0 border-dashed border">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button"
                                ...
                                <span class="d-lg-block d-none">
                                    <h5 class="my-0 fw-normal user-info">
                                        <?php echo $username; ?> 
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPagesAuth">
                                <ul class="side-nav-second-level">
                                    <li>
                                    <div>Emp Management and Access</div>
                                    
                                    </li>
                                    <li>
                                        <ul>
                                            <li><a href="auth-login.php">Login</a></li>
                                            <li><a href="auth-emp-login.php">Employee Registration</a></li>
                                            <li><a href="auth-emp-update.php">Update Exsisting</a></li>
                                        </ul>
                                    ...
                                    <li>
                                        <a href="auth-verification.php">Verification</a>
                                    </li>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat text-bg-pink">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase mt-0" title="Customers">Total Entries</h6>
                                        <h2 class="my-2">24</h2>
                                        <p class="mb-0">
                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            ...
                                            <h5 class="header-title mb-0">Complete Intern Data</h5>
                                        </div>
