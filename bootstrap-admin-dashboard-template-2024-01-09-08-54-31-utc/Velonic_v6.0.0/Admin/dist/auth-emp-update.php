<?php
include('assets/php/session_login.php'); // Include the session management file
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card overflow-hidden bg-opacity-25">
                        <form action="assets/php/emp_update.php" method="POST" enctype="multipart/form-data" style="background: radial-gradient(circle, rgba(247,247,247,1) 0%, rgba(124,150,172,1) 34%);">
                            <div class="row g-0">
                                <!-- First Column -->
                                <div class="col-lg-6 px-4 pt-3">
                                    <div class="p-0">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="status" id="emp-status" required>
                            ...
                            <div class="d-flex justify-content-center mb-3">
                                <button class="btn fw-semibold" type="submit" name="emp_update" style="background-color: #1a2942; color: #ffffff;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
