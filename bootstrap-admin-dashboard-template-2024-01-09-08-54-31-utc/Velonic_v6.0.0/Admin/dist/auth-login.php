...
<head>
    <meta charset="utf-8" />
    <title>Log In | IITK - Dashboard</title>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <p class="mb-3" style="color: #696969;">Enter the details to access the Admin Page..
                                        </p>

                                        <!-- form -->
                                        <form action="assets/php/login.php" method="POST">
                                            <div class="mb-3">
                                                <label for="username" class="form-label" style="color: #1a2942; ">Username</label>
                                                <input class="form-control" type="text" id="username" required="" name="username"
                                                    placeholder="Enter your username">
                                            </div>
                                            <div class="mb-3">
                                                <!-- <a href="auth-forgotpw.html" class="float-end" style="color: #696969;"><small>Forgot
                                                        your
                                                        password?</small></a> -->
                                            ...
                                            <div class="mb-0 text-start">
                                                <button class="btn w-100" type="submit" style="background-color: #1a2942; color: #ffffff;">
