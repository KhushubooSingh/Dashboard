                    ...
                    <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPagesAuth">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="auth-emp-login.php">Employee Login</a>
                                    </li>
                                    <li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Verify your Certificate</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="assets/php/verification-search-name.php" method="post">
                                ...
                                <h4 class="card-title">Search with your registered name</h4>
                                ...
                                <button type="submit" class="btn btn-primary" name="search_by">Search</button>
                            </div> <!-- end card-->
                            </form>
                        </div> <!-- end col-->
                        <div class="col-sm-6">
                            ...
                            <div class="card card-body">
                                <h4 class="card-title">Search with your registration no.</h4>
                                <!-- <p class="card-text">With supporting text below as a natural lead-in to additional
                                    content.</p> -->
                                    <div class="pb-2">
