            ...
            <div class="row justify-content-center">
                <div class="col-xxl-8 col-lg-10">
                    <div class="card overflow-hidden bg-opacity-25">
                        <form action="assets/php/emp_registration.php" method="POST" enctype="multipart/form-data">
                            <div class="row g-0">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        <div class="p-0 my-auto">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="other" required="" id="other" name="other"
                                ...
                                <div class="mb-2 d-flex justify-content-center">
                                    <button class="btn btn-primary fw-semibold" type="submit" name="emp_submit">Submit</button>
                                </div> <!-- end button -->
                            </div>
                        </form>
                    </div>
